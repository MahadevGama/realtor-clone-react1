      ...
      <section>
        ...
        <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
          ...
          <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-14'>
            ...
            <button className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded-md shadow-md hover:bg-blue-900 transition duration-1000 ease-in-out hover:shadow-lg active:bg-green-300' type="submit">sign in</button>
